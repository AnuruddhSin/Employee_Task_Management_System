function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
    ...
    function h(e = null) {
        for (var t of (v.innerHTML = "", d))
            if (t.selected) !w(t.value) && f(t);
                ...
                n.innerHTML = t.label, n.dataset.value = t.value,
                e && t.label.toLowerCase().startsWith(e.toLowerCase()) ?
                v.appendChild(n) : e || v.appendChild(n);
            }
    }
    ...
    function f(e) {
        ...
        n.classList.add("item-label"), n.innerHTML = e.label,
        n.dataset.value = e.value;
        const l = (new DOMParser).parseFromString(
            '<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 1 1" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="item-close-svg">\n' +
    ...
    n = document.getElementById(e), function () {
        ...
        (u = document.createElement("button")).type = "button", s.append(u);
        const e = m.parseFromString(
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">\n' +
            '<polyline points="18 15 12 21 6 15"></polyline></svg>', "image/svg+xml"
        ).documentElement;
        u.append(e), i.append(s), a.append(i),
        (p = document.createElement("div")).classList.add("drawer", "hidden"),
        t.shadow && p.classList.add("shadow"),
        t.rounded && p.classList.add("rounded"),
        p.append(c), v = document.createElement("ul"), p.appendChild(v),
        l.appendChild(a), l.appendChild(p),
        n.nextSibling ? n.parentNode.insertBefore(l, n.nextSibling) :
